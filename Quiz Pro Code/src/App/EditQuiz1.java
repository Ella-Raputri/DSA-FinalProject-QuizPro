 ...
 * @author asus
 */
public class EditQuiz1 extends javax.swing.JFrame {
     ...
     */
    public EditQuiz1() {
        updateLinkedList(EditQuiz1.quizlist);
        initComponents();        
    }
    
    public EditQuiz1(String quizId){
        EditQuiz1.quizID = quizId;
        updateLinkedList(EditQuiz1.quizlist);
        initComponents();
        myinit();
    }
    ...
    private void updateLinkedList(LinkedlistBenchmark list){
        try{
            ...
            pstmt.setString(1, EditQuiz1.quizID);
            ...
            while(rs.next()){
                ...
                list.addQuestionUpdate(quest, ans, EditQuiz1.quizID, opt1, opt2, opt3, opt4);
    ...
    private void myinit(){
        ...
        Linkedlist.Node current = EditQuiz1.quizlist.quiz.head;
        while(current!=null){
            totalElement++;
        ...
        int x=10;
        Linkedlist.Node currentQuestion = EditQuiz1.quizlist.quiz.head;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditQuiz1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
